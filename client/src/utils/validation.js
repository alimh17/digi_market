...
export const mobileSchema = Yup.object({
    ...
    features: Yup.string().required("ویژگی های خاص موبایل الزامی میباشد").min(8, "ویژگی های خاص موبایل نمیتواند کمتر از 8 کاراکتر باشد").max(500, "ویژگی های خاص موبایل نمیتواند بیشتر از 500 کاراکتر باشد")
})
